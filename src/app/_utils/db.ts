// In development, the command next dev clears Node.js cache on run. This in turn initializes a 
// new PrismaClient instance each time due to hot reloading that creates a connection to the database. 
